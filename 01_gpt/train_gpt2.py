...
from create_config_gpt2 import create_config_gpt2
from utils.util import set_seed


def parse():
    parser = argparse.ArgumentParser()
    parser.add_argument("--dataset_name", type=str, default="rocstories")
    parser.add_argument("--project_name", type=str, default="actdm")
...
if __name__ == '__main__':
    ...
    args = parse()
    config = create_config_gpt2(args)

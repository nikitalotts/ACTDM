...
if __name__ == '__main__':
    ...
    config.training.checkpoints_prefix = "gpt2-scratch-512-0.0002-rocstories"
    config.training.checkpoint_name = "70000"

    decoding = getattr(args, "decoding", "greedy") 
    config.decoding = decoding

    config.sampling = getattr(config, "sampling", {})
